...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VMEndpoint) DeepCopyInto(out *VMEndpoint) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VMEndpoint.
func (in *VMEndpoint) DeepCopy() *VMEndpoint {
	if in == nil {
		return nil
	}
	out := new(VMEndpoint)
